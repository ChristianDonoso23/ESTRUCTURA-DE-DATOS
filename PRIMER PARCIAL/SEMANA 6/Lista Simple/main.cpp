...
int main() {
    ...
    while(opcion != 3) {
        ...
        switch(opcion) {
            case 1:
                primerNombre = lista->ingresarLetras("Ingrese primer nombre: ");
                segundoNombre = lista->validarLetras("Ingrese segundo nombre: ", true);
                apellido = lista->ingresarLetras("Ingrese apellido: ");
                do {
                    cout << "Ingrese cedula: ";
